...
uint8_t* ProtobufMessage::_InternalSerialize(
  ...
  if (this->_internal_double_type_size() > 0) {
    target = stream->WriteFixedPacked(1, _internal_double_type(), target);
  }

  // repeated float float_type = 2;
  if (this->_internal_float_type_size() > 0) {
    target = stream->WriteFixedPacked(2, _internal_float_type(), target);
  }
  ...
  // repeated int32 int32_type = 3;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          3, _internal_int32_type(), byte_size, target);
    }
  }
  ...
  // repeated int64 int64_type = 4;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt64Packed(
          4, _internal_int64_type(), byte_size, target);
    }
  }
  ...
  // repeated uint32 uint32_type = 5;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(
          5, _internal_uint32_type(), byte_size, target);
    }
  }
  ...
  // repeated uint64 uint64_type = 6;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteUInt64Packed(
          6, _internal_uint64_type(), byte_size, target);
    }
  }

  // repeated bool bool_type = 7;
  if (this->_internal_bool_type_size() > 0) {
    target = stream->WriteFixedPacked(7, _internal_bool_type(), target);
  }
